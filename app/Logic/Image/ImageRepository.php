...
class ImageRepository
{
    public function upload( $form_data )
    {
        ...
        $validator = Validator::make($form_data, ImageSlider::$rules, ImageSlider::$messages);
        ...
        $sessionImage = new ImageSlider;
        $sessionImage->filename      = $allowed_filename;
        $sessionImage->original_name = $originalName;
        $sessionImage->slider_id = $slider;
    ...
    public function delete( $filename )
    {
        ...
        $sessionImage = ImageSlider::where('filename', 'like', $filename)->first();
