        ...
        <div class="col-md-12">
          <div class="row">
              <div class="col-md-offset-1 col-md-10">
                  ...
                  <div class="jumbotron how-to-create">
                      <ul>
                          <li>EL tamaño ideal es 1118x350</li>
                          <li>Tamaño maximo 8MB</li>
                      </ul>
...
@section('footer')
  <script src="{{ url('assets/js/admin/dropzone.js')}}"></script>
  <script src="{{ url('assets/js/admin/dropzone-config-2.js')}}"></script>
@endsection